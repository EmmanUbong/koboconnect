...
<form id="contact-frm" action="{{route('adminupdate',$user->id)}}" method="POST" role="form" enctype="multipart/form-data" style="user-select: auto;" onSubmit="return validate();">
  @method('PATCH')   
...
<div class="form-group" style="user-select: auto;">
  ...
  <input type="text" value="{{ $user->company_name}}" name="company_name"  class="form-control" id="exampleInputEmail1" placeholder="Company Name" style="user-select: auto;" required>
</div>
...
<div class="form-control" style="user-select: auto;">
 ...
 <div class="form-group" style="user-select: auto;">
  ...
  <div class="form-group" style="user-select: auto;">
    ...
    <input type="url" value="{{ $user->facebook}}" id="facebook" name="facebook"  class="form-control" placeholder=" facebook url"  style="user-select: auto;"required >
  </div>
  

  <div class="form-group" style="user-select: auto;">
    <label style="user-select: auto;">twitter</label>
    <input type="url" value="{{ $user->twiter}}" name="twitter" id="twitter" class="form-control" placeholder=" twitter url"  style="user-select: auto;"required >
  </div>

  <div class="form-group" style="user-select: auto;">
    <label style="user-select: auto;">instagram</label>
    <input type="url" value="{{ $user->instagram}}" name="instagram" id="instagram" class="form-control" placeholder=" instagram url"  style="user-select: auto;"required >
  </div>
  
  <div class="form-group" style="user-select: auto;">
    <label style="user-select: auto;">whatsapp</label>
    <input type="url" value="{{ $user->whatsapp}}" name="whatsapp" id="whatsapp"  class="form-control" placeholder=" whatsapp group url"  style="user-select: auto;"required >
  </div>
  @endforeach 
