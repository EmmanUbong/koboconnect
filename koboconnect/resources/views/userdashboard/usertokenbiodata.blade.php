...
<div class="form-group" style="user-select: auto;">
  ...
  <label name="email" value="{{ Auth::user()->email}}" sty="user-select: auto;">Email: {{ Auth::user()->email}}</label> --}}
  ...
  <input type="hidden" value="{{ Auth::id() }}" name="AuthID" class="form-control" id="AuthID" placeholder="AuthID" style="user-select: auto;"  required>
          ...
          <div class="form-group" style="user-select: auto;">
            <label for="exampleInputEmail1" style="user-select: auto;">Artisan Reference	Token</label>
            <input type="text" value="{{ old('ArtisanReferenceToken') }}" name="ArtisanReferenceToken" class="form-control" id="ArtisanReferenceToken" placeholder="Artisan Reference	Token" style="user-select: auto;"  required>
          </div>
      ...
      <script type="text/javascript">
        $(document).ready(function() {
            // $('button').click(function() {
              ...
              alert("Dear Employee, Thank you can register artisan reference token.");
            // });
        });
      ...
      <script type="text/javascript">
        $(document).ready(function() {
            // $('button').click(function() {
              $('#submitt').attr('disabled', 'disabled');
              alert("Dear artisan, try and register your bio-data.");
            // });
        });
