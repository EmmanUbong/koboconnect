...
<form id="contact-frm" action="{{route('registerDetailStore')}}" method="POST" role="form" enctype="multipart/form-data" style="user-select: auto;" onSubmit="return validate();">
  @csrf  
...
<div class="form-group" style="user-select: auto;">
  ...
  <input type="text" value="{{ old('company_name') }}" name="company_name"  class="form-control" id="exampleInputEmail1" placeholder="Company Name" style="user-select: auto;" required>
</div>
...
<div class="form-group" style="user-select: auto;">
  <label for="exampleInputEmail1" style="user-select: auto;">Work Days and Time</label>
 ...
 <div class="form-group" style="user-select: auto;">
  ...
  <div class="form-group" style="user-select: auto;">
    ...
    <input type="url" value="{{ old('twitter') }}" name="twitter" id="twitter" class="form-control" placeholder=" twitter url"  style="user-select: auto;"required >
  </div>
...
{{-- <script type="text/javascript" src="../frontend/js/a.js"></script>
