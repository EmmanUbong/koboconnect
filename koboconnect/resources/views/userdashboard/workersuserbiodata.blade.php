...
{{-- {{route('WorkerDetailStore')}} --}}

    <form id="contact-frm" action="{{route('WorkerDetailStore')}}" method="POST" style="user-select: auto;" role="form" enctype="multipart/form-data" >
...
<div class="form-group" style="user-select: auto;">
  ...
  <input type="hidden" value="{{ Auth::id() }}" name="AuthID" class="form-control" id="AuthID" placeholder="AuthID" style="user-select: auto;"  required>
        ...
        {{-- <div class="form-group" style="user-select: auto;">
          ...
          <div class="form-group" style="user-select: auto;">
            <label for="exampleInputEmail1" style="user-select: auto;">Name</label>
         
            <input type="text" value="{{ old('names')}}" id="names" name="names" class="form-control" id="names" placeholder="Name" style="user-select: auto;"  required>
          </div>
